...
class VisaStockController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.executive_one.visa-stock.index',compact('visaDetails','visaStocks','agent','group'));
    }
    ...
    public function create()
    {
        ...
        $agent = AgentDetail::all();
        return view('backend.executive_one.visa-stock.create',compact('agent'));
    }
...
//        ]);
        ...
        return redirect()->route('executive_one.visa-stock.index');
    }
...
//        $suppliers = Supplier::all();
        ...
        return view('backend.executive_one.visa-stock.edit', compact('vDetails','agent'));
    }
    ...
    public function VisaDivided($id)
    {
        ...
        $visaStockID = $id;
        return view('backend.executive_one.visa-stock.visa-divided',compact('groupVisa','visaStockID'));
    }
...
//        ]);
    ...
    public function GroupWiseVisaEdit($id){
        ...
        return view('backend.executive_one.visa-stock.group_wise_visa_edit', compact('GWVisa','agent','group'));
    }
