                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{route('executive_one.supplier.create')}}">
                    ...
                    <div class="card-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td class="click">
                                    <a href="{{route('executive.one.stamping-passport',$supplier->id)}}"><strong>{{!empty($stock->quantity) ? $stock->quantity : 'Stock Not Available'}}</strong></a>
                                </td>
                                <td class="click">
                                    <a href="{{route('executive.one.all-stamping-passport',$supplier->id)}}"><strong>{{!empty($stampingPass->count()) ? $stampingPass->count() : 'Not Yet stamping'}}</strong></a>
                                </td>
                                <td class="click">
                                    <a href="{{route('executive.one.available-passport',$supplier->id)}}"><strong>{{$availablePass->count()}}</strong></a>
                                <td>
                                    {{--<a class="btn btn-success waves-effect" href="{{route('executive_one.supplier.edit',$supplier->id)}}">
                                        <i class="fa fa-eye"></i>
                                    </a>--}}
                                    <a class="btn btn-info waves-effect" href="{{route('executive_one.supplier.edit',$supplier->id)}}">
