                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{route('executive_one.visa-stock.index')}}">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('executive_one.visa-stock.update',$vDetails->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
