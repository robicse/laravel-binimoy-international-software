                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{route('executive_one.visa-stock.create')}}">
                       ...
                       //print_r($check_data1);
                            if ($check_data1 ==''){
                                ...
                                <tr>
                                    ...
                                    <td>{{$vDetails->per_piece_price}}</td>
                                    <td>{{$vDetails->total_price}}</td>
                                    <td style="color:darkgreen; font-size: 20px;"><b>{{$available_quantity1}}</b></td>
                                    <td>
                                        {{--<a class="btn btn-success waves-effect" href="{{route('executive_one.visa-stock.visa_divided',$vDetails->id)}}">
                                            <i class="fa fa-eye"></i>
                                        </a>--}}
                                        <a class="btn btn-info waves-effect" href="{{route('executive_one.visa-stock.edit',$vDetails->id)}}">
