        ...
        <div class="sidebar" >
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="{{route('executive.two.dashboard')}}" class="nav-link {{Request::is('executive/two/dashboard*') ? 'active' : ''}}">
                    ...
                    <li class="nav-item" style="padding-top: 7px;">
                        <a href="{{route('executive.two.order.index')}}" class="nav-link {{Request::is('executive/two/order*') ? 'active' : '' || Request::is('executive/two/supplier_wise_passport*') ? 'active' : ''}}">
