    ...
    <section class="content">
        <div class="row">
            ...
            <!-- general form elements -->
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{route('admin.agent.update',$agentDetail->id)}}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                       <div class="row">
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" name="previous_pay" id="previous_pay" value="{{$agentDetail->previous_pay}}">
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
