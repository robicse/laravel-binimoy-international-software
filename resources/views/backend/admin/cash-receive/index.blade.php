...
@section("title","Cash Received List")
@push('css')
            ...
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Cash Received Lists</h3>
                    ...
                    <div class="card-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td class="bg-success text-right text-bold">{{number_format($totalpay, 2)}}</td>
