            ...
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Order Invoice List</h3>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($orders as $order)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger waves-effect" title="Edit Invoice" href="{{route('admin.order.invoice',$order->id)}}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a class="btn btn-primary waves-effect" title="View Invoice" href="{{route('admin.accounts.invoice.view',$order->id)}}">
                                            <i class="fa fa-file"></i>
                                        </a>
                                        @if($order->due_amount !='0')
                                            <a class="btn btn-success waves-effect" title="Take Payment" href="{{route('admin.accounts.invoice.take.payment',$order->id)}}">
