        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-info card-outline">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{route('admin.order.create')}}" method="get" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group" style="width: 120px!important;">
                                                ...
                                                <span style="color:red">Police Clearance</span>
                                            </div>
                                        </td>{{--
                                        <td>
                                            <div class="form-group">
                                        ...
                                        <td>
                                            <div class="form-group" style="width: 120px!important;">
                                                ...
                                                <span style="color:red">Medical Clearance</span>
                                            </div>
                                        </td>
                                        {{--<td style="width: 50px!important;">
                                            <div class="form-group">
                                                <label for="img">Visa Issue Date</label>
                                                <input type="date" value="" name="visa_issue_date[]" class="form_datetime form-control">
                                            </div>
                                        </td>--}}
        ...
        $(document).ready(function(){
            ...
            $('#add').click(function(){
                ...
                $('#dynamic_field').append(
                    ...
                    '</td>'+
                    '<td width="">'+
                    '<select class="form-control pc select2" name="pc[]">' + pc +'</select>'+
                    '</td>'+
                    '<td width="">'+
                    '<select class="form-control mc select2" name="mc[]">' + mc +'</select>'+
                    '</td>'+
                    '<td width="2%">'+
