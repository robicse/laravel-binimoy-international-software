            ...
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Expense Lists</h3>
                        <div class="float-right">
                            <a href="{{route('admin.expense-manage.create')}}">
                    ...
                    <div class="card-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($expense as $key => $expense_data)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td>{{$expense_data->title}}</td>
                                    <td>{{$expense_data->cate_name}}</td>
                                    <td>{{$expense_data->amount}}</td>
                                    <td>{{$expense_data->description}}</td>
                                    <td>{{$expense_data->date}}</td>
                                    <td>
                                        <a class="btn btn-info waves-effect" href="{{route('admin.expense-manage.edit',$expense_data->id)}}">
