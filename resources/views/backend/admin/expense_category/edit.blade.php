        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-info card-outline">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.expense-category.update',$exp_cate->id)}}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group">
                                <label for="cate_name">Category Name</label>
                                <input type="text" class="form-control" name="cate_name" id="cate_name" value="{{$exp_cate->cate_name}}">
                            </div>
                        </div>
                        <!-- /.card-body -->
